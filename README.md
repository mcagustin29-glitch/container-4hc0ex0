...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-4hc0ex0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-4hc0ex0.containers.anotherwebservice.com/
...
```
git clone git@github.com:mcagustin29-glitch/container-4hc0ex0.git
cd container-4hc0ex0
```
...
```
docker attach container-4hc0ex0
```
